export default {
    props: {
        descriptions: {
            required: false,
            default: `لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از
            طراحان گرافیک است ، چاپگرها و متون بلکه روزنامه و مجله در تون و سطرآنچنان
            ...
            دشواری موجود در او جوابگی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد
            استفاده قرار گیرد.`
        }
    }
}